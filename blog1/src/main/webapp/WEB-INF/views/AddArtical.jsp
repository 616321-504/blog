            ...
            <form class="form-horizontal" name="add_artical_form" action="<%=basePath %>article/save" method="post">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="category" name="art.category.id">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" id="summary" name="art.summary"  placeholder="摘要" rows="5"></textarea>
                    </div>

                    <div class="form-group">
                        <textarea class="form-control" id="content" name="art.content"  placeholder="文章内容" rows="5"></textarea>
                    </div>
