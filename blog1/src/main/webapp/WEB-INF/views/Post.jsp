    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="well">
                ...
                <form role="form" name="comment" action="<%=basePath %>comment/commit?userId=${user.id}&artId=${article.id}" method="post" onsubmit="return isValidate(comment)">
            ...
            <c:forEach items="${pc.list}" var="cmt">
                ...
                <p>
                    <i class="icon-user"></i><a
                        href="<%=basePath %>user/myblog?userId=${cmt.user.id}" target="_blank">
            ...
            <div>
                ...
                <ul class="pager">
                    <c:if test="${pc.curPage > 1}">
                        <li class="previous">
                            <a href="<%=basePath%>comment/post?artId=${article.id}&curPage=<c:out value="${pc.curPage-1}"/>">&larr;
                                上一页</a>
                        </li>
                    </c:if>
                    ...
                    <c:if test="${pc.curPage< pc.totalPages}">
                        <li class="next"><a
                                href="<%=basePath%>comment/post?artId=${article.id}&curPage=<c:out value="${pc.curPage+1}"/>">下一页
                            &rarr;</a>
                        </li>
                    </c:if>
                </ul>
